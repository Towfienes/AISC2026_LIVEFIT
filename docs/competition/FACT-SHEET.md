...
| Sổ sự cố | **47 sự cố có nguyên nhân gốc** (đếm 15/09/2026 — thêm: số A/A không tái lập, bộ lọc lọt handle có dấu, khai sai nguồn gốc nhãn) | đếm số hàng bảng trong `docs/incident-log.md` |
