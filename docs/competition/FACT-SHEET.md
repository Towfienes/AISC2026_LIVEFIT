...
| Sổ sự cố | **52 sự cố có nguyên nhân gốc** (đếm 17/09/2026 — thêm: kho bộ nhớ lưu trùng dưới tải, WebSocket nhận trễ, link đo đếm thiếu sau proxy, compose không truyền INGEST_TOKEN, đường Shopee trả 422) | đếm số hàng bảng trong `docs/incident-log.md` |
