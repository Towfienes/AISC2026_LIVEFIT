...
PROVINCES: tuple[str, ...] = (
    ...
    "an giang", "bà rịa - vũng tàu", "bà rịa vũng tàu", "vũng tàu", "bạc liêu", "bắc giang",
    ...
    "thừa thiên huế", "huế", "tiền giang", "trà vinh", "tuyên quang", "vĩnh long", "vĩnh phúc",
    "yên bái", "sài gòn", "tphcm", "tp hcm", "hồ chí minh",
)

DISTRICTS: tuple[str, ...] = (
    # TP.HCM
    "gò vấp", "bình thạnh", "tân bình", "tân phú", "phú nhuận", "bình tân", "thủ đức",
    "củ chi", "hóc môn", "bình chánh", "nhà bè", "cần giờ", "quận 1", "quận 2", "quận 3",
    "quận 4", "quận 5", "quận 6", "quận 7", "quận 8", "quận 9", "quận 10", "quận 11",
    "quận 12", "thủ dầu một", "dĩ an", "thuận an", "biên hòa",
    # Hà Nội
    "hoàn kiếm", "ba đình", "đống đa", "hai bà trưng", "cầu giấy", "thanh xuân", "hoàng mai",
    "long biên", "tây hồ", "nam từ liêm", "bắc từ liêm", "hà đông", "gia lâm", "đông anh",
    "sơn tây", "thanh trì", "hoài đức",
    # other metros
...
_VN_WORD_CHARS = (
    "\\wàáảãạăằắẳẵặâầấẩẫậèéẻẽẹêềếểễệìíỉĩị"
